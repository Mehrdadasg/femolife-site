    ...
    <main className="md:h-screen max-w-5xl mx-auto flex flex-wrap md:flex-nowrap px-5 gap-20 pt-36 md:pt-44 lg:pt-52">
      <section className="w-full md:w-[55%] text-center md:text-start">
        ...
        <div className="flex justify-center md:justify-start gap-5 mt-10">
          <LinkCM href="/blog" className="!text-[13px] font-bold" title={t("goMagazine")}>
            <Book1 size={20} color="#fff" />
            {t("goMagazine")}
          </LinkCM>
          <LinkCM href="/" title={t("goHome")} variant="outline" color="default" className="!text-[13px] font-bold">
            {t("goHome")}
          </LinkCM>
        </div>
      </section>
      <section className="mx-auto md:w-[40%] pb-20 md:pb-0">
        <Image src="/illustration/404.png" className="w-full h-auto" width={900} height={900} alt="404" />
      </section>
    </main>
  );
}
